...
@section('content')
    ...
    @section('script')
        <script>
            //map
            var map = L.map('map').setView([-6.2400, 106.8317], 12);
            ...
            function createPopupContent(feature) {
                return " Kecamatan : " + feature.properties.NAME_3 + "<br>" +
                    " Jumlah TK:  " + feature.properties.tk_1 + "<br>"+
                    " Jumlah SD : " + feature.properties.sd_1 + "<br>" +
                    " Jumlah SMP:  " + feature.properties.smp_1 +"<br>" +
                    " Jumlah SMK:  " +feature.properties.sma_1;
            ...
            // Load GeoJSON data
            $.getJSON("{{ asset('jakarta.json') }}", function(data) {
        ...
        L.Control.Watermark = L.Control.extend({
            onAdd: function(map) {
                ...
                img2.src = "/storage/img/logo3_.png";
